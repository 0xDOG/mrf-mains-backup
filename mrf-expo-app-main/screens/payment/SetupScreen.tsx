      ...
      <View style={tailwind('w-full h-full px-4 pt-24 flex flex-col')}>
        ...
        {type === 'sepa_debit' && (
          <View style={tailwind('w-full mt-4  text-center self-end')}>
            <Text thin center>
              Ich authorisiere (A) myregionalfood Zahlungen von meinem Konto via
              Direkt Debit abzubuchen. Weiters (B) stimme ich meiner Bank zu,
              die Zahlungen von myregionalfood auszugleichen. Anmerkung: Ich
              kann eine Rückerstattung innerhalb von 8 Wochen ab dem
              Buchungsdatum einfordern. Die verinbarten Bankkondition sind
              geltend.
            </Text>
          </View>
        )}
